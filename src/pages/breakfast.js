...
query BfastPostListing {
    allMarkdownRemark(filter: { frontmatter: { crop: {eq: 1 }, meal: {eq: "breakfast" } } } ) {
    edges {
        node{
            excerpt
            frontmatter {
...
background: #E8C753;
background: -webkit-radial-gradient(top right, #E8C753, #97B6A5);
background: -moz-radial-gradient(top right, #E8C753, #97B6A5);
background: radial-gradient(top right, #E8C753, #97B6A5);

...
query dinnerPostListing {
    allMarkdownRemark(filter: { frontmatter: { crop: {eq: 1 }, meal: {eq: "dinner" } } } ) {
    edges {
        node{
            excerpt
            frontmatter {
...
background: #344C68;
background: -webkit-radial-gradient(top right, #344C68, #97B6A5);
background: -moz-radial-gradient(top right, #344C68, #97B6A5);
background: radial-gradient(top right, #344C68, #97B6A5);
